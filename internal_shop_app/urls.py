...
from .views import agregar_producto_view, agregar_venta_view, editar_producto_view, eliminar_producto_view, eliminar_producto_yes_view, eliminar_venta_view, eliminar_venta_yes_view, home_view, tabla_venta_view,  tabla_view
